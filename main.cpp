...
int main() {
   ...
   //Question 2
    int lengthOfArray = sizeof(words)/sizeof(words[0]);
    cout<<"The words starts with letter e: \n" ;
    ...
    cout<<"------------------\n";
    int length2 = sizeof(words)/sizeof(words[0]);
    cout<<"The words starts with letter 'ha' : \n" ;
